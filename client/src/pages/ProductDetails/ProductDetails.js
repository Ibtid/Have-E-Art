...
const ProductDetails = () => {
    ...
    const onClickFollow = async() => {
      setShowSpinner(true)
      const response = await dispatch(actions.followEart, {id}, {}, contextStore.user.token)
      console.log(response)
      if(response.errors){
        setShowSpinner(false)
        return
    ...
    const onClickUnfollow = async() => {
      setShowSpinner(true)
      const response = await dispatch(actions.unfollowEart, {id}, {}, contextStore.user.token)
      console.log(response)
      if(response.errors){
        setShowSpinner(false)
        return
            ...
            <div className="productDetails">
                ...
                <div className="productDetails__outlinedButtons">
                    <div className="productDetails__canShrinkButton">
                        <img
                            ...
                            alt=""
                        />
                        <div className="productDetails__shrinkButtonText">
                            Share
                        </div>
                    </div>
                        ...
                        !checkIfOwner(contextStore, eart.owner._id) && (
                            <div className="productDetails__canShrinkButton">
                                <img
                                    ...
                                    alt=""
                                />
                                {eart.followers.includes(
                                    contextStore.user._id
                                ) ? (
                                    <div className="productDetails__shrinkButtonText" onClick={onClickUnfollow}>
                                        Following
                                    </div>
                                ) : (
                                    <div className="productDetails__shrinkButtonText" onClick={onClickFollow}>
                                        Follow
                                    </div>
                                )}
                            </div>
                ...
                <div className="productDetails__dateAndViews">
                    ...
                    <div className="productDetails__views">
                        <img
                            ...
                            alt="views"
                        />
                        <div className="productDetails__viewsNumber">
                            {" "}
                            198,222
                        </div>
                    </div>
                ...
                <div className="productDetails__fileTypeAndDimension">
                    ...
                    <div className="productDetails__dimension">
                        ...
                        <div className="productDetails__dimensionText">
                            1920 * 1080
                        </div>
                    </div>
                </div>
                    ...
                    eart.flag.forSale && (
                        <div className="productDetails__absoluteSection">
                            <div className="productDetails__priceTag">
                                <div className="productDetails__priceText">
                                    Price:{" "}
                                </div>
                ...
                {checkIfOwner(contextStore, eart.owner._id) &&
                    eart.flag.forSale && (
                        <div className="productDetails__absoluteSection">
                            ...
                            >
                                <div className="productDetails__changePrice">
                                    Change Price
                                </div>
                            </div>
                            <div
