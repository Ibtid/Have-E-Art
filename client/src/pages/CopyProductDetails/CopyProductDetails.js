            ...
            <div className="productDetails">
                <div className="productDetails__firstRow">
                    <div className="productDetails__name">
                        {copyEart.edition.eart.title} - {copyEart.edition.name}{" "}
                        Edition
                    </div>
                </div>
                ...
                {editPrice && (
                    <>
                        ...
                        >
                            ...
                            ></div>
                            <div className="addOrEditProductText__checkboxText">
                                Private
                            </div>
                        </div>
                        <div
                                ...
                                <Link
                                    ...
                                    onClick={(e) => {
                                      ...
                                      if(contextStore.user){
                                        setContextStore({
                                          ...contextStore,
                                          eart: {...copyEart.edition.eart,_id:copyEart._id, type: "copytransfer", title: `${copyEart.edition.eart.title} - ${copyEart.edition.name} Edition`,
                                          type: 'copytransfer',
